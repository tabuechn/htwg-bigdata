...
docker run -p 27017:27017 -d=true --name "main" akka-http-microservice-mainserver:1.0

# Workerserver compilieren und starten
cd ../WorkerServer
sbt docker:publishLocal
docker run -p 27018:27018 -d=true --name "worker" akka-http-microservice-workerserver:1.0
...
sh ../TerminalGui/ant_gui.sh 192.168.99.100:27017
